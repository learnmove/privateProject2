    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><router-link  v-if="isAuth" :to="{name:'mysell'}"><a href="#"><span class="glyphicon glyphicon-log-in"></span> 我的商店</a></router-link></li>
          <li><router-link v-if="isAuth" :to="{name:'change_school'}"><img style="width:25px; height:25px" v-bind:src="$auth.getUser().avatar" alt="" class="img-circle"><a href="#">{{$auth.getUser().account}}</a></router-link></li> 
